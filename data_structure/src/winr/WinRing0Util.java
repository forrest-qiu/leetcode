...
public class WinRing0Util {
    ...
    static WR0 WR0_INSTANCE = Native.load(WR0_DLL_NAME, WR0.class);
    static U32 U32_INSTANCE = Native.load("User32", U32.class);
     ...
     * 获取dll的状态
     */
    private static int GetDllStatus() {
     ...
     * 销毁
     */
    private static void DeinitializeOls() {
     ...
     * 初始化
     */
    private static void InitializeOls() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("dllStatus:" + dllStatus);
